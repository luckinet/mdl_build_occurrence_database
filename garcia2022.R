...
# comment     : file.edit(paste0(dir_docs, "/documentation/04_build_occurrence_database.md")); it seems like the training data are not usable out of the box, as there are no labels included and I don't find documentation on it.
# ----
...
regDataseries(name = thisDataset,
              ...
              reference = read.bib(paste0(thisDir, "10.1038_s41597-022-01674-y-citation.bib")))
