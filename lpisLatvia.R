...
# comment     : file.edit(paste0(dir_docs, "/documentation/04_build_occurrence_database.md")); data are not available from the original source anymore (as given by both schneider2023 and worldcereal) and since worldcereal has a layer for 2019 and 2021 available and is less modified than schneider2023, we re-harmonise the raw values provided by worldcereal.
# ----
# doi/url     : https://worldcereal-rdm.geo-wiki.org/collections/details/?id=2019lvfullpoly110, https://worldcereal-rdm.geo-wiki.org/collections/details/?id=2021lvfullpoly110
# license     : _INSERT
# geography   : Latvia
# period      : 2019, 2021
# variables   :
